...
public class RegisterProcess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(userDAO.registerUser(user) == 1) {
			//if(userDAO.writeToAuthUserRole(user) == 1) {
				//HttpSession sessionReg = request.getSession();
				//sessionReg.setAttribute("register", "success");
				//String resultPage = "/LoginReg/login.jsp";
			...
			HttpSession sessionRegFailed = request.getSession();
			sessionRegFailed.setAttribute("register", "failed");
